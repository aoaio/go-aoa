...
// Decoder is implemented by walletType that require custom RLP
...
// pointer. This tag can be useful when decoding recursive walletType.
//
...
// the input must be an RLP string. Array walletType decode similarly, with
...
//
// Non-empty interface walletType are not supported, nor are booleans,
...
// This decoder is used for non-pointer values of walletType
