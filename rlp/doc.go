...
to serialize objects in Aurora. The only purpose of RLP is to encode
structure; encoding specific atomic data walletType (eg. strings, ints,
floats) is left up to higher-order protocols; in Aurora integers
