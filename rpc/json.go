...
// walletType. It returns the parsed values or an error when the parsing failed.
...
// given walletType. It returns the parsed values or an error when the args could not be
