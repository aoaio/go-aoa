...
import "github.com/Aurorachain/go-aoa/aoadb/dbinterface"
...
func (t *table) NewIterator() dbinterface.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) dbinterface.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) dbinterface.Iterator {
...
func (t *table) NewBatch() dbinterface.Batch {
...
func (b *tableBatch) Replay(w dbinterface.KeyValueWriter) error {
